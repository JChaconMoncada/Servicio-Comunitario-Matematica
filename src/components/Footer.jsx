      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          <div>
            ...
            <p className="text-blue-100 text-sm md:text-base">Sistema de inscripciones tardías para el Departamento de Matemática y Física</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-blue-100 text-sm md:text-base">matyfis@unet.edu.ve</p>
          </div>
        </div>
