function Footer() {
  return (
    <footer className="bg-unet-dark text-white py-6 md:py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          <div>
            <h3 className="text-lg md:text-xl font-bold mb-4">UNET - Inscripciones Tardías</h3>
            <p className="text-gray-400 text-sm md:text-base">Sistema de inscripciones tardías para el Departamento de Informática</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm md:text-base">informatica@unet.edu.ve</p>
          </div>
        </div>
