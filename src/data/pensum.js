...
export const pensumMaterias = [
  ...
  { id: 'fund_log', nombre: 'Fundamentos de Lógica Digital', semestre: 4, fila: 3, uc: 3, prelaciones: ['mat_disc'] },
  ...
  // === SEMESTRE V ===
  { id: 'nec_val', nombre: 'Necesidades, Valores y Proyecto de Vida', semestre: 5, fila: 1, uc: 1, prelaciones: [] },
  { id: 'bd1', nombre: 'Base de Datos 1', semestre: 5, fila: 2, uc: 3, prelaciones: ['prog2'] },
  { id: 'org_comp', nombre: 'Organización del Computador', semestre: 5, fila: 3, uc: 4, prelaciones: ['fund_log'] },
  { id: 'auto', nombre: 'Automatización', semestre: 5, fila: 4, uc: 4, prelaciones: ['prog2'] },
  ...
  { id: 'io1', nombre: 'Investigación de Operaciones 1', semestre: 6, fila: 5, uc: 4, prelaciones: ['an_num'] },
  { id: 'serv_com', nombre: 'Servicio Comunitario', semestre: 6, fila: 8, uc: 0, prelaciones: ['proy_sc', 'sem_sc'] },
  { id: 'econ', nombre: 'Economía', semestre: 6, fila: 9, uc: 2, prelaciones: [] },
  ...
  { id: 'sist_dist', nombre: 'Sistemas Distribuidos', semestre: 8, fila: 3, uc: 3, prelaciones: ['comp_int'] },
  ...
  { id: 'ing_soft', nombre: 'Ingeniería de Software', semestre: 9, fila: 2, uc: 3, prelaciones: ['si2'] },
  ...
  { id: 'leg_val', nombre: 'Legislación, Valores y Proyecto País', semestre: 9, fila: 9, uc: 1, prelaciones: [] },
